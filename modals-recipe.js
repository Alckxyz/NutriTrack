...
export const recipeModals = `
    ...
    <div id="recipe-library-modal" class="modal">
        <div class="modal-content" style="max-width: 600px;">
            ...
            <div class="library-controls" style="display: flex; gap: 10px; flex-wrap: wrap; margin-bottom: 1rem;">
                <input type="text" id="recipe-library-search" placeholder="${t('search_recipes_placeholder', state.language)}" data-t-placeholder="search_recipes_placeholder" style="flex: 1; min-width: 200px; padding:10px; border-radius:6px; border:1px solid var(--border); background:var(--input-bg); color:var(--text);">
                <select id="recipe-library-sort-select" style="padding:10px; border-radius:6px; border:1px solid var(--border); background:var(--input-bg); color:var(--text); cursor:pointer;">
