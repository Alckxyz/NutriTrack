...
export function initRecipesUI(refreshUI) {
    ...
    if (dom.recipeLibrarySortSelect) {
        dom.recipeLibrarySortSelect.onchange = () => refreshRecipeLibrary();
    }
...
export function refreshRecipeLibrary() {
    UI.renderRecipeLibraryList(
        dom.recipeLibraryList, 
        dom.recipeLibrarySearch.value, 
        dom.recipeLibrarySortSelect,
        openRecipeEditor, 
        deleteRecipe
    );
}
